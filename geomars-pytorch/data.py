...
#         for sample in self.samples:
#             self.samples_dict[sample[1]].append(sample[0])
#         self.transform_general = transforms.Compose([
#         transforms.ToTensor(),
...
#
#         if self.transform_general is not None:
#             view1_PIL = self.transform_general(view1_PIL)
#             view3_PIL = self.transform_general(view3_PIL)
#             image = self.transform_general(image)
#

...
if __name__ == '__main__':
    build_db.build_db()
    mAP, mars_dist_avg = calcMAP.calc_map()
    #List of images that will be included in the result file
    ...
    for imagepath in image_list:
        resultpaths, query_ap, coordinate_distance, distance_list = query.query(imagepath)
